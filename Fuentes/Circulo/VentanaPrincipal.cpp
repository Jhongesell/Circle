...
void TFormaPrincipal::RetornarValoresConfiguracion(void)
{
   ...
   // Numero de rotación
   ////////////////////////////////////////////////////////
   AnsiString txt1(configura->EditR1->Text);
   num_rot.Rot_Num_iteraciones   = atoi(txt1.c_str());       
   AnsiString txt2(configura->EditR1->Text);
   num_rot.Rot_Condicion_Inicial = atof(txt2.c_str());       
   num_rot.Rot_sw_Cond_inicial_aleatoria = configura->CheckBoxR1->Checked;   
   ////////////////////////////////////////////////////////
   // Sincronizaciones
   ////////////////////////////////////////////////////////
   AnsiString txt3(configura->EditS1->Text);
   sincro.Res_Long_Min_transitorios     = atoi(txt3.c_str());       
   AnsiString txt4(configura->EditS2->Text);
   sincro.Res_Long_Max_transitorios     = atoi(txt4.c_str());       
   AnsiString txt5(configura->EditS3->Text);
   sincro.Res_Long_max_ciclo            = atoi(txt5.c_str());       
   AnsiString txt6(configura->EditS4->Text);
   sincro.Res_Tolerancia                = atof(txt6.c_str());       
   AnsiString txt7(configura->EditS5->Text);
   sincro.Num_condiciones_iniciales     = atoi(txt7.c_str());       
   AnsiString txt8(configura->EditS5->Text);
   sincro.Res_Condicion_Inicial         = atof(txt8.c_str());       
   sincro.Res_sw_Cond_inicial_aleatoria = configura->CheckBoxS1->Checked;   
   ////////////////////////////////////////////////////////
   // Exponente de Lyapunov
   ////////////////////////////////////////////////////////
   AnsiString txt9(configura->EditL2->Text);
   exp_lyap.Max_num_iteraciones  = atoi(txt9.c_str());       
   AnsiString txt10(configura->EditL3->Text);
   exp_lyap.Epsilon              = atof(txt10.c_str());       
   AnsiString txt11(configura->EditL4->Text);
   exp_lyap.Paso_derivada        = atof(txt11.c_str());       
   AnsiString txt12(configura->EditL5->Text);
   exp_lyap.Condicion_inicial    = atof(txt12.c_str());       
