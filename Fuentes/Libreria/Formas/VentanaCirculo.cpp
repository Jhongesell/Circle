...
void __fastcall TFormaCirculo::Atractors1Click(TObject *Sender)
{
   ...
   long double x, t, xt, xtmp, ytmp;
   int n_i, i, px, py;

   Grafica();
   // Color del punto periódico
   TColor color = Color_grafica[3];
   for (x = 0.0; x < 1.0; x += 1e-2) {
       t = x;
      // Transitorios
      ...
      xt = t;
//////////////////////////////////////////////////////////////////////////////////////////////////////      
// Al encontrar la órbitas periódicas almacene el período y la envolvencia de las órbitas encontradas
// al igual que el número de éstas.
// Para calcular la cuenca de atracción tomar una partición de condiciones iniciales e iterar un 
// transitorio dado, despues ver a que atractor converge y segun el numero de éste en el indice, dibujar
// el punto de condiciones iniciales con el color del indice
//////////////////////////////////////////////////////////////////////////////////////////////////////      
      // Busca orbitas periódicas
...
void TFormaCirculo::RetornarValoresConfiguracion(void)
{
   ...
   // Escenario
   ////////////////////////////////////////////////////////
   AnsiString txt1(configura->Edit8->Text);
   Condicion_inicial.X = atof(txt1.c_str());       
   AnsiString txt2(configura->Edit9->Text);
   Iteraciones         = atoi(txt2.c_str());       
