...
void TFormaToro::RetornarValoresConfiguracion(void)
{
   ...
   // Escenario
   ////////////////////////////////////////////////////////
   AnsiString txt2(configura->Edit8->Text);
   Condicion_inicial.X = atof(txt2.c_str());       
   AnsiString txt3(configura->Edit9->Text);
   Num_trazos          = atoi(txt3.c_str());       
   AnsiString txt4(configura->Edit10->Text);
   Num_iteraciones     = atoi(txt4.c_str());       
   Tipo_integracion    = configura->RadioButton1->Checked;   
   AnsiString txt5(configura->Edit11->Text);
   Puntos_trazar       = atoi(txt5.c_str());       
   /////////////////////////////////////////////////////////
   // Al terminar
   /////////////////////////////////////////////////////////
   Calcula_toro();
