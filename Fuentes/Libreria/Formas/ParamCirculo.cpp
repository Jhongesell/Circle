...
//---------------------------------------------------------------------------
#pragma resource "*.dfm"
TVCap_Circunferencia *VCap_Circunferencia;
//---------------------------------------------------------------------------

// Constructor de la clase
__fastcall TVCap_Circunferencia::TVCap_Circunferencia(TComponent* Owner) : TForm(Owner)
{
   Aceptar = false;
}

// Al presionar el boton de acptar
void __fastcall TVCap_Circunferencia::Button1Click(TObject *Sender)
{
   Aceptar = true;
   Close();        
}
...
// Cambio de color
void __fastcall TVCap_Circunferencia::Panel5Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Circunferencia::Panel6Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Circunferencia::Panel7Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Circunferencia::Panel8Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Circunferencia::Panel9Click(TObject *Sender)
{
...
void __fastcall TVCap_Circunferencia::ListBoxParametrosClick(TObject *Sender)
{
...
void __fastcall TVCap_Circunferencia::EditValorParametroKeyPress(TObject *Sender, char &Key)
{
   if (Key == VK_RETURN) {
      Key = 0;
