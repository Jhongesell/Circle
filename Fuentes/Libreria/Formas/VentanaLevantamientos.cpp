...
void TFormaLevantamientos::RetornarValoresConfiguracion(void)
{
   ...
   // Dimensiones
   ////////////////////////////////////////////////////////
   AnsiString txt2(configura->EditHMin->Text);
   Dim_Vtn.Xi = atof(txt2.c_str());       
   AnsiString txt3(configura->EditHMax->Text);
   Dim_Vtn.Xf = atof(txt3.c_str());       
   AnsiString txt4(configura->EditVMin->Text);
   Dim_Vtn.Yi = atof(txt4.c_str());       
   AnsiString txt5(configura->EditVMax->Text);
   Dim_Vtn.Yf = atof(txt5.c_str());       
   ////////////////////////////////////////////////////////
   // Visualizar
   ////////////////////////////////////////////////////////
   // Check Box
   ...
   // Escenario
   ////////////////////////////////////////////////////////
   AnsiString txt6(configura->Edit7->Text);
   Condicion_inicial.X = atof(txt6.c_str());       
   AnsiString txt7(configura->Edit8->Text);
   Puntos_trazar       = atoi(txt7.c_str());       
   AnsiString txt8(configura->Edit9->Text);
   Num_iteraciones     = atoi(txt8.c_str());       
   Tipo_integracion    = configura->RadioButton1->Checked;   
   AnsiString txt9(configura->Edit11->Text);
   Puntos_trazar       = atoi(txt9.c_str());       
   /////////////////////////////////////////////////////////
   // Al terminar
   /////////////////////////////////////////////////////////
...
// Iteración con el Mouse
void __fastcall TFormaLevantamientos::VTLevantamientosClick(TObject *Sender)
{
   Condicion_inicial.X = Vs.Xi; 
   Condicion_inicial.Y = 0.0;
   Calcula_lineas_levantamientos();
