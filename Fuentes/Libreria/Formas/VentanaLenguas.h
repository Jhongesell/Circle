...
class TFormaLenguas : public TForm
{
   __published:	// IDE-managed Components
        ...
        TPanel *Panel1;
        TPaintBox *VTLenguas;
        TMenuItem *LoadFileofTonguesTXT1;
        TOpenDialog *ConvertirArchivo;
        ...
        void __fastcall LoadFileofTonguesTXT1Click(TObject *Sender);
   private:	// User declarations
        ...
        char                   Msg[200];
        char                   Comentarios[505];

        Ventana_256           *pix; // Clase que contiene los graficos generados   
