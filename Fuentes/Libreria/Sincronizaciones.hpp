...
class Sincronizaciones: public FuncionDisparo 
{
   private:
      ...
      int           Arreglo_Sincronizaciones_Q[MAYORSINCRONIZACION];
      int           Arreglo_Sincronizaciones_P[MAYORSINCRONIZACION];
      long double            Tolerancia;

   public:
        
      int           Res_Long_max_ciclo ;
      int           Res_Long_Max_transitorios;
      int           Res_Long_Min_transitorios;
